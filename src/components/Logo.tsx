...
export function Logo(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    // The {...props} part is important to pass down any classes or styles.
    <svg
      width="1200"
      height="1200"
      xmlns="http://www.w3.org/2000/svg"
      xmlnsXlink="http://www.w3.org/1999/xlink" // FIX: Changed xmlns:xlink to xmlnsXlink
      version="1.1"
      {...props} // ADDED: This passes down props like className
    >
      <g transform="scale(13.547755445171777) translate(-5.875721719529884, -5.801221635606553)">
        <g fill="#004AAC">
          <g xmlns="http://www.w3.org/2000/svg">
            <path
              fillRule="evenodd" // FIX: Changed fill-rule to fillRule
              clipRule="evenodd" // FIX: Changed clip-rule to clipRule
